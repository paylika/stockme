...
-- ============================================================
-- Classement optimisé :
--   • Les produits DROPSHIPPING sont inclus dans le flux d'accueil
--     (avant : filtrés → invisibles).
--   • Équité vendeurs DOUCE : le 2e produit d'un vendeur subit une
--     petite pénalité (au lieu d'être renvoyé loin dans le classement),
--     donc les bons produits restent visibles.
--   • Bonus nouveauté conservé → les nouveaux produits remontent.
-- ============================================================
