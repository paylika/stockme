...
import { VERIFIED_BADGE_PRICE_FCFA, SERVICE_WHATSAPP, SERVICE_WHATSAPP_DISPLAY, verifiedBadgeWhatsAppLink } from "@/lib/constants";
import { AlertTriangle, Check, Copy, MessageCircle, ShieldCheck, Smartphone } from "lucide-react";
      ...
      <DialogContent className="max-h-[92svh] w-[calc(100%-1.5rem)] max-w-md overflow-y-auto rounded-2xl p-5 sm:p-6">
        <DialogHeader>
          ...
          <DialogDescription className="text-left">
            {VERIFIED_BADGE_PRICE_FCFA.toLocaleString("fr-FR")} FCFA — activation après vérification de votre paiement.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="rounded-2xl border border-border bg-muted/40 p-4">
          ...
          <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
            Envoyez le montant exact au numéro ci-dessus, puis revenez ici. Gardez la capture du paiement :
            elle sera demandée sur WhatsApp.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-center text-[11px] leading-relaxed text-muted-foreground">
            Demande traitée sous 24 h après réception de la capture. Badge activé sur votre profil, votre boutique
